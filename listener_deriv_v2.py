        ...
        try:
            async with websockets.connect(WEBSOCKET_URL, ping_interval=None) as websocket:
                ...
                for symbol in wanted_symbols:
                    ...
                    logging.info(f"🛎 Subscrito para TICKS de {symbol}")
            ...
            logging.warning(f"⚠️ Conexão encerrada: {e}. Reconnectando em 5s...")
            time.sleep(5)
        except Exception as e:
            logging.error(f"Erro inesperado: {e}")
            time.sleep(5)

# ✅ Essa função é chamada pelo main.py
def iniciar_listener():
    logging.info("🚀 Iniciando Listener com WebSocket Deriv V2")
